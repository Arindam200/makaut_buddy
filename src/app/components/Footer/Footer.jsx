...
export default function Footer() {
  return (
    <>
      <div className="font-sans border w-full overflow-hidden sm:px-20 px-10 text-slate-950 py-5 space-y-2  bg-gradient-to-b from-blue-500 to-purple-500">
        <div className="sm:flex  sm:divide-x-2 max-sm:divide-y-2 divide-slate-950 ">
          ...
          <div className="sm:px-20 hidden max-sm:text-center sm:pt-16 pt-10 sm:flex sm:space-x-40">
            <div className="">
              <ul className="space-y-2">
                <h1 className="font-medium text-lg pb-2 font-bold text-white">
                  Swapnoneel Saha
                </h1>
