      ...
      <div className=" sm:px-32 px-10 sm:py-20 py-10 sm:flex space-y-10">
        ...
        <div className="sm:w-1/2 w-full text-[#FFFFFF70]">
          <Accordion selectedKeys={selectedKeys} onSelectionChange={setSelectedKeys}>
            <AccordionItem className="text-[#FFFFFF70]" key="1" aria-label="Accordion 1" title="Are the resources reliable?">
              {content1}
            </AccordionItem>
            <AccordionItem className="text-[#FFFFFF70]" key="2" aria-label="Accordion 2" title="Can I get 9+ CGPA with this?">
              {content2}
            </AccordionItem>
            <AccordionItem className="text-[#FFFFFF70]" key="3" aria-label="Accordion 3" title="Is this free or do I need to pay?">
              {content3}
            </AccordionItem>
            <AccordionItem className="text-[#FFFFFF70]" key="4" aria-label="Accordion 4" title="Is this only helpful for MAKAUT students?">
              {content4}
            </AccordionItem>
          </Accordion>
        </div>
