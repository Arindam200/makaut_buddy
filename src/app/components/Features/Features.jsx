...
const Features = forwardRef(function Features(props, ref) {
  return (
    <>
      <div className="sm:px-32 flex relative px-16 bg-gradient-to-b from-blue-500 to-purple-500" ref={ref}>
        <div className="space-y-10 sm:py-20 pt-16">
          <h1 className="text-7xl max-sm:text-center font-bold ">
            Features
          </h1>
          <div className="flex max-sm:flex-col justify-start gap-10 ">
            <div className=" box w-64 h-96 text-white bg-black">
              <div className="tri"></div>
              <div className="pl-8 pt-1 pr-6 space-y-5 ">
                <h1 className="text-7xl text-start font-grenze font-bold">
                  1.
                </h1>
                <h3 className="text-lg text-[#171717] text-white">
            ...
            <div className=" box w-64 h-96 text-white ">
              <div className="tri"></div>
              <div className="pl-8 pt-1 pr-6 space-y-5 ">
                <h1 className="text-7xl text-start font-grenze font-bold">
                  2.
