...
export default function page() {
  ...
  return (
    <div className="h-full flex flex-col lg:flex-row">
      <div className="flex flex-col justify-between lg:basis-1/12 pt-28 bg-[#FFFFFF05] lg:border-r-2 border-[#FFFFFF20]">
      ...
      <div className="lg:basis-11/12 flex flex-col px-4 lg:px-12 pt-8 lg:pt-28 pb-5 gap-2">
        ...
        <Tabs />
        <div className="h-full flex flex-col lg:flex-row border-2 border-[#FFFFFF20] rounded-lg">
